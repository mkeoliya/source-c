...
export class ShiftWithoutReset extends RuntimeSourceError {
  constructor() {
    super()
  }

  public explain() {
    return `Found shift without a matching reset.`
  }
...
export class InvalidContinuationStack extends RuntimeSourceError {
  constructor() {
    super()
  }

  public explain() {
    return `Invalid continuation stack; should not be empty.`
  }
