...
import { Variant, ExecutionMethod, isCapturedCont } from '../types'
 ...
 */
function validChapterVariant(chapter: any, variant: any): boolean {
...
function main() {
  const opt = require('node-getopt')
    .create([
      ...
      ['v', 'variant=VARIANT', 'set the Source variant (i.e., cont)', 'cont'],
  ...
  startRepl(chapter, executionMethod, variant, useRepl, prelude)
}
